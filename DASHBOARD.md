...
*Snapshot 2026-09-02 (fleet sweep: the universal home breadcrumb deploy) — refresh by invoking `/dave-core:dashboard` in this repo.*
...
| Deploy cadence | 🟢 active (last: **2026-09-01 09:29** — the breadcrumb went from opt-in to universal: every mobile popup now opens `🏠 › {tool}` and the tap puts the student back on the page they launched from) | git log |
